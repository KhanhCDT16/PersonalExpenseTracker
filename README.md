...
In the installer, choose **Custom**, select **New SQL Server standalone installation**, and enable **LocalDB** on the Feature Selection page. Complete the installation and then open a new, non-administrator PowerShell window. Create and start the instance under your normal Windows account:
